...
from .views import UserViewSet, PostViewSet, LikeViewSet, CommentViewSet, FollowViewSet,LoginView, RegisterView, UserProfileAPIView, UserProfileUpdateAPIView, FollowUserAPIView, FollowerListAPIView, FollowingListAPIView,SearchView
...
urlpatterns = [
    ...
    path('follows/', FollowUserAPIView.as_view(), name='follow-user'),
    path('follows/followers/<int:user_id>/', FollowerListAPIView.as_view(), name='follower-list'),
    path('follows/following/<int:user_id>/', FollowingListAPIView.as_view(), name='following-list'),
